...
export const loadFiles = async (
  ...
  try {
    ...
    console.log('loadFiles: basePath =', basePath);
    console.log('loadFiles: all files =', fs.readdirSync(basePath));
    console.log('loadFiles: js files =', files);
    ...
    for (const file of files) {
      ...
      console.log('loadFiles: importing', filePath, pathToFileURL(filePath).href);
